...
console.log('Test 3: Brief Generation');
{
    ...
    assert(brief.concept.statement.includes('photographer') || brief.concept.statement.includes('portfolio'), 'Concept should reference intent');
...
console.log('Test 5: Chaos Tolerance Effect');
{
    ...
    lowChaosGenome.c11_chaos_tolerance = 0.2;
    const highChaosGenome = generateCreatorGenome('high-chaos');
    // Manually set high chaos
    highChaosGenome.c11_chaos_tolerance = 0.8;
...
console.log('Test 6: Cross-Pollination Effect');
{
    ...
    lowCrossGenome.c12_cross_pollination = 0.2;
    const highCrossGenome = generateCreatorGenome('high-cross');
    highCrossGenome.c12_cross_pollination = 0.8;
    ...
    assert(highCrossPersona.worldview.unusual_connections.length >
        lowCrossPersona.worldview.unusual_connections.length, 'High cross-pollination should have more connections');
...
console.log('Test 7: Coherence Style Effect');
{
    ...
    integratedGenome.c15_coherence_style = 0.8;
    const fragmentedGenome = generateCreatorGenome('fragmented');
    fragmentedGenome.c15_coherence_style = 0.2;
    ...
    assert(integratedPersona.creative_behavior.coherence_style === 'integrated', 'High coherence should be integrated');
    assert(fragmentedPersona.creative_behavior.coherence_style === 'fragmented', 'Low coherence should be fragmented');
