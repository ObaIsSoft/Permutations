...
export interface PreloaderEntry {
    type: PreloaderType;
    description: string;
    forbiddenFor: {
...
export const PRELOADER_CATALOG: PreloaderEntry[] = [
    {
        type: "none",
...
export function getPreloaderEntry(type: PreloaderType): PreloaderEntry {
...
export function selectPreloaderType(opts: {
    ...
    if (philosophy === "minimalist") return "minimal_bar";
