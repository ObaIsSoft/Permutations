...
export type IconStyle =
    | "thin"        // featherweight, elegant, minimal stroke
    | "sharp"       // angular, precise, geometric
    | "rounded"     // friendly, approachable, smooth
    | "bold"        // heavy weight, assertive, high contrast
    | "expressive"  // personality-rich, detailed, illustrated feel
    | "systematic"; // minimal curated set, UI-component focused
...
export const ICON_CATALOG: IconLibraryEntry[] = [
    // ── Thin / Elegant ────────────────────────────────────────────────────────
    {
        name: "Iconoir",
        package: "iconoir",
 ...
 */
export function formatIconLibraryNote(lib: IconLibraryEntry): string {
    return `/* ── Icon Library ───────────────────────────────────────────
   Library  : ${lib.name}
