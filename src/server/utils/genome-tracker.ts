...
export interface FullTrackerReport {
    L1: TrackerReport;
    L2: TrackerReport;
    L3: TrackerReport;
    totalUsed: number;
 ...
 */
export function createChromosomeAccessTracker(genome: any) {
 ...
 */
export function createFullGenomeTracker(
    genome: any, 
    ecosystemGenome?: any, 
    civilizationGenome?: any
) {
    ...
    return {
        ...
        getFullReport: (): FullTrackerReport => {
