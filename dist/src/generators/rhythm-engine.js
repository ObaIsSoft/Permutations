 ...
 */
export function getSectionRhythmAttrs(genome) {
    const pattern = (genome.chromosomes.ch12_signature?.rhythmPattern ?? "color_band");
 ...
 */
export function getRhythmMotifElement(pattern, indent = "") {
    switch (pattern) {
        case "shape_motif":
 ...
 */
export function getSectionParity(sectionIndex) {
