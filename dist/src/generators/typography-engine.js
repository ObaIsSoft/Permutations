 ...
 */
export function generateTypographyOutput(genome) {
    const sig = genome.chromosomes.ch12_signature;
    const ch3 = genome.chromosomes.ch3_type_display;
    ...
    const cssParts = ["/* ── Typography Treatments ─────────────────────────────────────── */"];
    const jsParts = [];
 ...
 */
function generateTreatmentCSS(treatment) {
    switch (treatment) {
...
// ── JS per treatment ──────────────────────────────────────────────────────────
function generateTreatmentJS(treatment) {
    switch (treatment) {
        case "split_char":
            return `
