...
export function generateTransitionOutput(genome) {
 ...
 */
function generateTransitionCSS(type) {
    const base = `
...
function generateTransitionTypeCSS(type) {
    switch (type) {
        case "opacity_fade":
            return `
...
// ── JS ────────────────────────────────────────────────────────────────────────
function generateTransitionJS(type) {
    switch (type) {
        case "opacity_fade":
