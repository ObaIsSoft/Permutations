...
export class HTMLGenerator {
    generate(genome, options = {}) {
        const { includeHeader = true, includeFooter = true, includeSections = false, heroOnly = false } = options;
        if (heroOnly) {
  ...
  <div class="container">
    ...
    generateTrustAuthorityHero(genome, _layout) {
        const copy = genome.chromosomes.ch25_copy_engine;
    ...
    generateStatsCounterHero(genome, _layout) {
        const copy = genome.chromosomes.ch25_copy_engine;
    ...
    generateSearchDiscoveryHero(genome, _layout) {
        const copy = genome.chromosomes.ch25_copy_engine;
        return `  <div class="hero-content">
    <h1 class="text-h1">${copy.headline}</h1>
    <p class="hero-subtitle">${copy.subheadline}</p>
    ...
    generateBrandLogoHero(genome, _layout) {
        const copy = genome.chromosomes.ch25_copy_engine;
        return `  <div class="hero-content">
    ...
    generateTestimonialFocusHero(genome, _layout) {
        const copy = genome.chromosomes.ch25_copy_engine;
        return `  <div class="hero-content">
    ...
    generateEditorialFeatureHero(genome, _layout) {
        const copy = genome.chromosomes.ch25_copy_engine;
        return `  <div class="hero-content">
    <h1 class="text-h1">${copy.headline}</h1>
    ...
    generateAspirationalImageryHero(genome, _layout) {
        const copy = genome.chromosomes.ch25_copy_engine;
        return `  <div class="hero-content">
    <h1 class="text-h1">${copy.headline}</h1>
    <p class="hero-subtitle">${copy.subheadline}</p>
    ...
    generateConfigurator3DHero(genome, _layout) {
        const copy = genome.chromosomes.ch25_copy_engine;
    ...
    generateContentCarouselHero(genome, _layout) {
        const copy = genome.chromosomes.ch25_copy_engine;
    ...
    generateProductVideoHero(genome, _layout) {
        const copy = genome.chromosomes.ch25_copy_engine;
        return `  <div class="hero-content">
    <h1 class="text-h1">${copy.headline}</h1>
    <p class="hero-subtitle">${copy.subheadline}</p>
  ...
  <div class="container">
    ...
    generateSocialProofSection(genome) {
        const social = genome.chromosomes.ch22_social_proof;
        let content = '';
        switch (social.type) {
